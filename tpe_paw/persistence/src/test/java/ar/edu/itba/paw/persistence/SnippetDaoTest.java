...
public class SnippetDaoTest {
    ...
    public void setUp() {
        ...
        JdbcTestUtils.deleteFromTables(jdbcTemplate, "snippets");
        JdbcTestUtils.deleteFromTables(jdbcTemplate, "users");
        long userId = userDao.createUser(USERNAME, PASSWORD, EMAIL, "", 0, DATE.format(Calendar.getInstance().getTime().getTime()));
        user = userDao.findUserById(userId).get();
        lang = languageDao.addLanguage("Java");
    }
