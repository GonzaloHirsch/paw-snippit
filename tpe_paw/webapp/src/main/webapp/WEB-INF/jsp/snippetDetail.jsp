    ...
    <div class="snippet-detail-main-row">
        <div class="snippet-detail-left-col">
            <div class="vote-buttons">
                <form:form action="/snippet/vote" method="post" modelAttribute="vote">
                    UP<form:radiobutton path="type" value="1" onchange="this.form.submit()"/>
                    DOWN<form:radiobutton path="type" value="0" onchange="this.form.submit()"/>
