...
<html>
<head>
    <title><spring:message code="passwordRecovery.invalid.title"/></title>
...
<div class="wrapper">
    ...
    <div class="main-content flex-center">
        ...
        <div class="flex-column flex-center form-block form-border">
            ...
            <div class="flex-column flex-center form form-border form-shadow">
                <div class="form-info-text">
                    <div class="form-field-container">
                        <spring:message code="passwordRecovery.invalid.info"/>
                    </div>
                </div>
                <a class="flex-center form-border form-field-size form-button form-button-basics form-buttons-margin fw-500" href="<c:url value='/recover-password'/>">
                    <spring:message code="passwordRecovery.invalid.submit"/>
                </a>
            </div>
        </div>
    </div>
